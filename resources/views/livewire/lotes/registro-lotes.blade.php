<div class="p-6">
    <div class="bg-blue-600 text-white p-4 rounded-t-lg mb-4">
        <h2 class="text-xl font-bold">REGISTRO DE NUEVO LOTE</h2>
    </div>
    ...
    <div class="bg-gray-800 p-6 rounded-b-lg shadow-md text-gray-200">
            ...
            <div>
                ...
                <select wire:model="proveedor_id" class="w-full bg-gray-900 border border-gray-700 p-2 rounded text-white">
                    ...
                    @foreach($proveedores as $prov)
                        <option value="{{ $prov->id }}">{{ $prov->nombre . ' - ' .$prov->empresa }}</option> @endforeach
                </select>
        ...
        <div class="mt-6 flex justify-end gap-3">
            ...
            <button wire:click="guardar" class="bg-blue-600 text-white px-4 py-2 rounded">Guardar Lote</button>
        </div>
    </div>
</div>
